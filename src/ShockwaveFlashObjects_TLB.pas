...
// Fichier généré le 21/05/2012 12:13:16 depuis la bibliothèque de types ci-dessous.
...
// Erreurs :
//   Remarque : paramètre 'label' dans IShockwaveFlash.TGotoLabel changé en 'label_'
//   Remarque : paramètre 'property' dans IShockwaveFlash.TSetProperty changé en 'property_'
//   Remarque : paramètre 'property' dans IShockwaveFlash.TGetProperty changé en 'property_'
//   Remarque : paramètre 'label' dans IShockwaveFlash.TCallLabel changé en 'label_'
//   Remarque : paramètre 'property' dans IShockwaveFlash.TSetPropertyNum changé en 'property_'
//   Remarque : paramètre 'property' dans IShockwaveFlash.TGetPropertyNum changé en 'property_'
//   Remarque : paramètre 'property' dans IShockwaveFlash.TGetPropertyAsNumber changé en 'property_'
// ************************************************************************ //
// *************************************************************************//
// REMARQUE :                                                                      
...
// Nom du contrôle      : TShockwaveFlash
// Chaîne d'aide        : Shockwave Flash
// Interface par défaut : IShockwaveFlash
// DISP Int. Déf. ?     : No
// Interface événements : _IShockwaveFlashEvents
...
// *********************************************************************//
// La classe CoFlashObjectInterface fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IDispatchEx exposée             
// par la CoClasse FlashObjectInterface. Les fonctions sont destinées à être utilisées par            
...
// Chaîne d'aide        : IFlashObjectInterface Interface
// Interface par défaut : IDispatchEx
// DISP Int. Déf. ?     : No
...
// *********************************************************************//
// La classe CoFlashObject fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IFlashObject exposée             
// par la CoClasse FlashObject. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoFlashObject = class
...
// Chaîne d'aide        : FlashObject Class
// Interface par défaut : IFlashObject
// DISP Int. Déf. ?     : No
// Interface événements : 
// TypeFlags            : (2) CanCreate
// *********************************************************************//
